...
export default function DashboardDemo() {
  ...
  const [sessions] = useState<DemoSession[]>(() => generateSessions());
  ...
  // Generate events when live and visible
  useEffect(() => {
    if (!isLive || !sectionVisible) return;
  ...
  }, [isLive, sessions, sectionVisible]);
    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          >
            Try the dashboard.{" "}
            <span className="gradient-text-accent">Right here.</span>
          </h2>
          <p
            className="font-[family-name:var(--font-figtree)]"
            style={{
          ...
          >
            This is a live simulation. Every event, session, and cost metric
            you see is generated in real time.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <Stat label="Active Sessions" value={sessions.length.toString()} color="var(--accent-indigo)" />
            <Stat label="Est. Cost" value={`$${totalCost.toFixed(3)}`} color="var(--accent-violet)" />
            <Stat label="Errors" value={errorCount.toString()} color={errorCount > 0 ? "#ef4444" : "var(--text-muted)"} />
          </div>

          {/* Content */}
          <div style={{ minHeight: 420, maxHeight: 480, overflow: "hidden" }}>
            {activeTab === "timeline" && (
              <TimelineView
                ref={timelineRef}
            ...
            {activeTab === "costs" && <CostsView events={events} sessions={sessions} />}
          </div>
        </div>
    ...
    <div style={{ overflowX: "auto" }}>
      ...
      >
        <thead>
          ...
          >
            {["Session", "Agent", "Started", "Duration", "Events", "Cost", "Errors"].map(
              (h) => (
                <th
                  key={h}
                  style={{
            ...
            >
              ...
              <td style={{ padding: "12px 16px" }}>
                <span
                  ...
                  style={{
                    fontSize: 11,
                    color: s.errorCount > 0 ? "#ef4444" : "#22c55e",
                  }}
                >
                  {s.errorCount}
                </span>
